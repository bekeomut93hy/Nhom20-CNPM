                ...
                <Route path="/app/profile" render={() => {
                    return (
                        <div className="col-12">
                            ...
                            <div className="row" style={{padding: "15px 0 15px 0", cursor: "pointer "}}>
                                <span className="ml-2 mx-auto" onClick={this.props.handleLogout} style={styleTieude}>Đăng xuất </span>
                            </div>
                        </div>
                    )
                }} />
